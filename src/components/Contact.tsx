...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-12 sm:py-16 lg:py-20 bg-gray-50 dark:bg-gray-900 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-md">
              <div className="flex items-start">
                ...
                <div >
                  ...
                  <a href="mailto:contact@example.com" className="text-sm sm:text-base text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors break-all">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-md">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-sm sm:text-base text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                    +91 93900-83562
                  </a>
                </div>
              </div>
          ...
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 lg:p-8 shadow-md">
              {submitSuccess && (
                <div className="mb-4 sm:mb-6 p-4 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-lg text-sm sm:text-base">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-gray-50 dark:bg-gray-700 border ${
              ...
              <button
                ...
                className={`w-full px-4 sm:px-6 py-2 sm:py-3 flex items-center justify-center text-sm sm:text-base ${
                  isSubmitting 
